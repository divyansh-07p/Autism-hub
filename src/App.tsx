...
function App() {
  const [userRole, setUserRole] = useState<'child' | 'adult' | null>(null);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Navigation currentView={currentView} setCurrentView={setCurrentView} userRole={userRole} setUserRole={setUserRole} />
      {renderView()}
    </div>
  );
}
